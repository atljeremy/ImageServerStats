class StaticsController < ApplicationController
  ...
  def index
    ...
    @download_time_graph_url = create_pie_chart_for_download_time
    @processing_time_graph_url = create_pie_chart_for_processing_time
  end
  ...
  def create_pie_chart_for_download_time
    @photos = Photo.all.order('download_time DESC')
  ...
  def create_pie_chart_for_processing_time
    @photos = Photo.all.order('processing_time DESC')
